  ...
  return (
    <section className="relative w-full px-12 pt-6 pb-12 lg:px-24 lg:pt-10 lg:pb-16">
      <div className="flex flex-col items-center text-center">
        {/* Top headline: ANONYMOUS AID. -- Geist Pixel Grid */}
        <motion.h1
        ...
        {/* Bottom headline: ZERO FRAUD. -- Geist Pixel Grid */}
        <motion.h1
          initial={{ opacity: 0, y: 30, filter: "blur(8px)" }}
          animate={{ opacity: 1, y: 0, filter: "blur(0px)" }}
        ...
        >
          Zeker leverages zero-knowledge proofs and native Soroban smart contracts on Stellar to deliver humanitarian cash assistance with 100% beneficiary anonymity and cryptographic double-claiming prevention.
        </motion.p>
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.97 }}
          className="group flex items-center gap-0 bg-foreground text-background text-sm font-mono tracking-wider uppercase font-bold"
        >
