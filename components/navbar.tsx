    ...
    >
      <nav className="w-full border border-foreground/20 bg-background/80 backdrop-blur-sm px-6 py-3 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          >
            <Cpu size={16} strokeWidth={1.5} className="text-[#ea580c]" />
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-foreground text-background px-4 py-2 text-xs font-mono tracking-widest uppercase font-bold"
            >
              Launch Sandbox
            </motion.a>
          </motion.div>
